...
const CATEGORY_SLUG_MAP = {
  ...
  metalurgico: 'metalurgia',
  metalúrgico: 'metalurgia',
  metalurgicos: 'metalurgia',
  ...
  portón: 'metalurgia',
  porton: 'metalurgia',
  estructura: 'metalurgia',
  // Legacy: tickets o mensajes antiguos con carpintería
  carpintero: 'metalurgia',
  carpintería: 'metalurgia',
  carpinteria: 'metalurgia',
  // Pintura
  pintor: 'pintura',
  pintura: 'pintura',
  // Piletas
